...
//        setContentView(R.layout.activity_help);
        ...
        help_body_left_body_lv.setAdapter(new HelpAdapter(getList(), HelpActivity.this));
        help_body_left_body_lv.setOnItemClickListener(new OnItemClickListener() {
    ...
    private void showAbout(){
		...
		view = LayoutInflater.from(HelpActivity.this).inflate(R.layout.activity_help_about, null);
		about_system_num_info = (TextView) view.findViewById(R.id.about_system_num_info);
    ...
    private void showAboutUs(){
    	view = LayoutInflater.from(HelpActivity.this).inflate(R.layout.activity_help_us, null);
    	help_right_about_back_btn = (Button) view.findViewById(R.id.help_right_about_back_btn);
