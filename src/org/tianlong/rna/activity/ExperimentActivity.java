...
public class ExperimentActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		defaultExperiments = experimentDao.getAllDefaultExperiments(ExperimentActivity.this);
		...
		experiment_left_delete.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				if(chooseE_id != -1){
					...
					Toast.makeText(ExperimentActivity.this, getString(R.string.exp_no_select), Toast.LENGTH_SHORT).show();
				}
			}
		});
		...
		expetiment_left_new.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				if(newControlNum%2 == 0){
					expetiment_left_new_btn.setText(getString(R.string.exp_new_exp));
	...
	private void showNewView(){
		view = LayoutInflater.from(ExperimentActivity.this).inflate(R.layout.activity_experiment_new_prepare, null);
		experiment_new_prepare_body_name_et = (EditText) view.findViewById(R.id.experiment_new_prepare_body_name_et);
		experiment_new_prepare_body_quick_cb = (CheckBox) view.findViewById(R.id.experiment_new_prepare_body_quick_cb);
		experiment_new_prepare_body_remark_et = (EditText) view.findViewById(R.id.experiment_new_prepare_body_remark_et);
		experiment_new_prepare_body_btn_next = (Button) view.findViewById(R.id.experiment_new_prepare_body_btn_next);
		experiment_new_prepare_body_template_sp = (Spinner) view.findViewById(R.id.experiment_new_prepare_body_template_sp);
		
		experiment_new_prepare_body_template_sp.setAdapter(new SpinnerAdapter(ExperimentActivity.this, Utlis.getTemplate(ExperimentActivity.this)));
		
		experiment_new_prepare_body_quick_cb.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
				if(isChecked){
					Toast.makeText(ExperimentActivity.this, getString(R.string.exp_add_quick), Toast.LENGTH_SHORT).show();
				}
				else{
					Toast.makeText(ExperimentActivity.this, getString(R.string.exp_cancle_quick), Toast.LENGTH_SHORT).show();
				}
			}
		});
		
		experiment_new_prepare_body_template_sp.setSelection(0);
		experiment_new_prepare_body_template_sp.setOnItemSelectedListener(new OnItemSelectedListener() {
		...
		experiment_new_prepare_body_btn_next.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				if(experiment_new_prepare_body_name_et.getText().toString().equals("")){
					Toast.makeText(ExperimentActivity.this, getString(R.string.exp_name_null), Toast.LENGTH_SHORT).show();
				}
				else{
					AlertDialog.Builder builder = new AlertDialog.Builder(ExperimentActivity.this);
					...
					dialog = builder.show();
					Intent intent = new Intent(ExperimentActivity.this, CreatExperimentActivity.class);
					if(experiment_new_prepare_body_quick_cb.isChecked()){
	...
	private void showView(){
		...
		view = LayoutInflater.from(ExperimentActivity.this).inflate(R.layout.activity_experiment_right_info, null);
		experiment_info_top_ename_tv = (TextView) view.findViewById(R.id.experiment_info_top_ename_tv);
		experiment_info_body_save_btn = (Button) view.findViewById(R.id.experiment_info_body_save_btn);
		experiment_info_body_cdate_info_tv = (TextView) view.findViewById(R.id.experiment_info_body_cdate_info_tv);
		experiment_info_body_rdate_info_tv = (TextView) view.findViewById(R.id.experiment_info_body_rdate_info_tv);
		experiment_info_body_quick_cb = (CheckBox) view.findViewById(R.id.experiment_info_body_quick_cb);
		experiment_info_body_remark_info_et = (EditText) view.findViewById(R.id.experiment_info_body_remark_info_et);
		experiment_info_body_remark_info_tv = (TextView) view.findViewById(R.id.experiment_info_body_remark_info_tv);
		experiment_info_bottom_edit_btn = (Button) view.findViewById(R.id.experiment_info_bottom_edit_btn);
		experiment_info_bottom_run_btn = (Button) view.findViewById(R.id.experiment_info_bottom_run_btn);
		experiment_info_body_remark_info_btn = (Button) view.findViewById(R.id.experiment_info_body_remark_info_btn);
		experiment_info_body_remark_info_cancle_btn = (Button) view.findViewById(R.id.experiment_info_body_remark_info_cancle_btn);
		...
		experiment_info_body_quick_cb.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
				if(isChecked){
				...
				experimentDao.updateExperiment(experiment, ExperimentActivity.this);
			}
		});
		...
		experiment_info_body_remark_info_tv.setOnLongClickListener(new OnLongClickListener() {
			public boolean onLongClick(View v) {
				experiment_info_body_remark_info_cancle_btn.setVisibility(View.VISIBLE);
				experiment_info_body_remark_info_btn.setVisibility(View.VISIBLE);
				experiment_info_body_remark_info_et.setVisibility(View.VISIBLE);
				experiment_info_body_remark_info_et.setFocusable(true);
				experiment_info_body_remark_info_et.setFocusableInTouchMode(true); 
				experiment_info_body_remark_info_et.requestFocus();
				InputMethodManager im = ((InputMethodManager)getSystemService(INPUT_METHOD_SERVICE));
				im.showSoftInput(experiment_info_body_remark_info_et, 0);
				experiment_info_body_remark_info_tv.setVisibility(View.GONE);
				return false;
			}
		});
		
		experiment_info_body_remark_info_btn.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				experiment.setEremark(experiment_info_body_remark_info_et.getText().toString());
				if(experimentDao.updateExperiment(experiment, ExperimentActivity.this)){
					Toast.makeText(ExperimentActivity.this, getString(R.string.exp_edit_success), Toast.LENGTH_SHORT).show();
					experiment_info_body_remark_info_cancle_btn.setVisibility(View.GONE);
					experiment_info_body_remark_info_btn.setVisibility(View.GONE);
					experiment_info_body_remark_info_et.setVisibility(View.GONE);
					experiment_info_body_remark_info_tv.setText(experiment_info_body_remark_info_et.getText().toString());
					experiment_info_body_remark_info_tv.setVisibility(View.VISIBLE);
				}
				else{
					Toast.makeText(ExperimentActivity.this, getString(R.string.exp_edit_failure), Toast.LENGTH_SHORT).show();
				}
			}
		});
		
		experiment_info_body_remark_info_cancle_btn.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				experiment_info_body_remark_info_cancle_btn.setVisibility(View.GONE);
				experiment_info_body_remark_info_btn.setVisibility(View.GONE);
				experiment_info_body_remark_info_et.setVisibility(View.GONE);
		...
		experiment_info_bottom_run_btn.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				AlertDialog.Builder builder = new AlertDialog.Builder(ExperimentActivity.this);
				builder.setMessage(getString(R.string.exp_prepareing));
				builder.setCancelable(false);
				dialog = builder.show();
				Intent intent = new Intent(ExperimentActivity.this, RunExperimentActivity.class);
				intent.putExtra("U_id", U_id);
				intent.putExtra("Uname", Uname);
		...
		experiment_info_bottom_edit_btn.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				AlertDialog.Builder builder = new AlertDialog.Builder(ExperimentActivity.this);
				builder.setMessage(getString(R.string.exp_creating));
				builder.setCancelable(false);
				dialog = builder.show();
				Intent intent = new Intent(ExperimentActivity.this, EditExperimentActivity.class);
				intent.putExtra("U_id", U_id);
				intent.putExtra("Uname", Uname);
				intent.putExtra("E_id", experiment.getE_id());
				startActivity(intent);
	    ...
	    if (event.getAction() == MotionEvent.ACTION_DOWN) {
	        if (ExperimentActivity.this.getCurrentFocus() != null) {  
	            if (ExperimentActivity.this.getCurrentFocus().getWindowToken() != null) {  
	                imm.hideSoftInputFromWindow(ExperimentActivity.this.getCurrentFocus().getWindowToken(),  
