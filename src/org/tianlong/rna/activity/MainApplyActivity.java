		...
		public void handleMessage(Message msg) {
			...
			if(info.length() != 0){
				if(info.substring(21, 23).equals("00")){
					...
					ma_bottom_gv.setAdapter(new MainApplyAdapter(MainApplyActivity.this,getguanList()));
				}
				else{
					try {
						utlis.sendMessage(Utlis.getseleteMessage(8));
					} catch (Exception e) {
						Toast.makeText(MainApplyActivity.this, getString(R.string.wifi_error), Toast.LENGTH_SHORT).show();
					}
				}
			}
		};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ma_bottom_gv.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				switch (arg2) {
				case 0:
					intent = new Intent(MainApplyActivity.this, ExperimentActivity.class);
					break;
				case 1:
					try {
						if(utlis != null){
						...
						utlis = new WifiUtlis(MainApplyActivity.this);
						intent = new Intent(MainApplyActivity.this, RunFileActivity.class);
					} catch (Exception e) {
						Toast.makeText(MainApplyActivity.this, getString(R.string.wifi_error), Toast.LENGTH_SHORT).show();
					}
					break;
				case 2:
					intent = new Intent(MainApplyActivity.this, MachineActivity.class);
					break;
				case 3:
					intent = new Intent(MainApplyActivity.this, UpAndDownActivity.class);
					break;
				case 4:
					if(utlis != null){
						try {
						...
						AlertDialog.Builder builder = new AlertDialog.Builder(MainApplyActivity.this);
						...
						builder.setNegativeButton(getString(R.string.stop), new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int which) {
								try {
									utlis.sendMessage(Utlis.ultravioletCloseMessage());
								} catch (Exception e) {
									// TODO Auto-generated catch block
									e.printStackTrace();
								}
						...
						dialog = builder.show();
						ma_bottom_gv.setAdapter(new MainApplyAdapter(MainApplyActivity.this,getList()));
					}
					else{
						Toast.makeText(MainApplyActivity.this, getString(R.string.wifi_error), Toast.LENGTH_SHORT).show();
					}
					break;
				case 5:
					intent = new Intent(MainApplyActivity.this, HelpActivity.class);
					break;
				default:
					break;
				}
