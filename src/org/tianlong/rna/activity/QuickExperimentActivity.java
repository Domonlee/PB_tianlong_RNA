...
public class QuickExperimentActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		list = experimentDao.getExperimentByQuick(QuickExperimentActivity.this,
				U_id);
		mb_bottom_gv = (GridView) findViewById(R.id.mb_bottom_gv);

		mb_bottom_gv.setAdapter(new MainApplyAdapter(
				QuickExperimentActivity.this, list));
		...
		mb_bottom_gv.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				AlertDialog.Builder builder = new AlertDialog.Builder(
						QuickExperimentActivity.this);
				builder.setMessage(getString(R.string.exp_prepareing));
				builder.setCancelable(false);
				dialog = builder.show();
				Intent intent = new Intent(QuickExperimentActivity.this,
		...
		mb_bottom_gv.setOnItemLongClickListener(new OnItemLongClickListener() {
			public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
				...
				String[] item = new String[] {
						getString(R.string.quick_now_cancle),
						getString(R.string.quick_all_cancle) };
				builder.setItems(item, new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int which) {
						...
						list = experimentDao.getExperimentByQuick(
								QuickExperimentActivity.this, U_id);
						mb_bottom_gv.setAdapter(new MainApplyAdapter(
								QuickExperimentActivity.this, list));
					}
				});
	...
	private void changQuick(int num) {
		...
		Experiment experiment = experimentDao.getExperimentById(E_id,
				QuickExperimentActivity.this, U_id);
		experiment.setEquick(0);
		experimentDao
				.updateExperiment(experiment, QuickExperimentActivity.this);
	}
