...
public class EditExperimentActivity extends Activity {
	...
	protected void onCreate(android.os.Bundle savedInstanceState) {
		...
		AlertDialog.Builder builder = new AlertDialog.Builder(EditExperimentActivity.this);
		...
		experiment = experimentDao.getExperimentById(E_id, EditExperimentActivity.this, U_id);
		...
		experiment_new_main_bottom_insert_btn.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				step.setStemp(0);
				editSteps.add(step);
				Toast.makeText(EditExperimentActivity.this, getString(R.string.exp_inset_success), Toast.LENGTH_SHORT).show();
				createTable();
			}
		});
				...
				if(stepChooseNum == -1){
					...
					builder.setPositiveButton(getString(R.string.sure), new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int which) {
							...
							Toast.makeText(EditExperimentActivity.this, getString(R.string.exp_delete_success), Toast.LENGTH_SHORT).show();
							createTable();
						}
					});
		...
		experiment_new_main_bottom_save_btn.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				if(experiment_new_main_bottom_ename_info_et.getText().toString().equals("")){
					Toast.makeText(EditExperimentActivity.this, getString(R.string.exp_name_null), Toast.LENGTH_SHORT).show();
				}
				else{
					String systemTime = Utlis.systemFormat.format(new Date(System.currentTimeMillis()));
					experiment.setRdate(systemTime);
					experiment.setEname(experiment_new_main_bottom_ename_info_et.getText().toString());
					experimentDao.updateExperiment(experiment, EditExperimentActivity.this);
					boolean flag = false;
					...
					if(flag){
						Toast.makeText(EditExperimentActivity.this, getString(R.string.exp_step_name_null), Toast.LENGTH_SHORT).show();
					}
					else{
						if(getVolIsNull()){
							if(getVolIsBig()){
								if(getTempIsNull()){
									if(getTempIsBig()){
										List<Step> deleteSteps = stepDao.getAllStep(EditExperimentActivity.this, experiment.getE_id());
										if(deleteSteps.size() != 0){
											for (int i = 0; i < deleteSteps.size(); i++) {
												stepDao.deleteStep(deleteSteps.get(i), EditExperimentActivity.this);
											}
										}
										for (int i = 0; i < editSteps.size(); i++) {
											editSteps.get(i).setSvol(Integer.valueOf(holders.get(i).experiment_new_main_item_body_vol_info_et.getText().toString()));
											editSteps.get(i).setStemp(Integer.valueOf(holders.get(i).experiment_new_main_item_body_temp_info_et.getText().toString()));
											stepDao.insertStep(editSteps.get(i), EditExperimentActivity.this);
										}
										Intent intent = new Intent(EditExperimentActivity.this, ExperimentActivity.class);
										intent.putExtra("U_id", U_id);
										intent.putExtra("Uname", Uname);
										startActivity(intent);
										finish();
										Toast.makeText(EditExperimentActivity.this, getString(R.string.exp_save_success), Toast.LENGTH_SHORT).show();
									}
									else{
										Toast.makeText(EditExperimentActivity.this, getString(R.string.exp_temp_big), Toast.LENGTH_SHORT).show();
									}
								}
								else{
									Toast.makeText(EditExperimentActivity.this, getString(R.string.exp_temp_empty), Toast.LENGTH_SHORT).show();
								}
							}
							else{
								Toast.makeText(EditExperimentActivity.this, getString(R.string.exp_vol_big), Toast.LENGTH_SHORT).show();
							}
							
						}
						else{
							Toast.makeText(EditExperimentActivity.this, getString(R.string.exp_vol_empty), Toast.LENGTH_SHORT).show();
						}
					}
				}
			}
	...
	private void createTable(){
		...
		if(editSteps.size()!=0){
			for (int i = 0; i < editSteps.size(); i++) {
				...
				LayoutInflater inflater = LayoutInflater.from(EditExperimentActivity.this);
				...
				holder.experiment_new_main_item_head_wait_info_tv.setText(step.getSwait());
				holder.experiment_new_main_item_head_blend_info_tv.setText(step.getSblend());
				holder.experiment_new_main_item_head_magnet_info_tv.setText(step.getSmagnet());
				holder.experiment_new_main_item_body_hole_info_tv.setText(step.getShole()+"");
				holder.experiment_new_main_item_body_vol_info_et.setText(step.getSvol()+"");
				//speed = step.getSspeed();
				holder.experiment_new_main_item_body_speed_info_tv.setText(step.getSspeed()+getString(R.string.exp_speed_unit));
				holder.experiment_new_main_item_body_temp_info_et.setText(step.getStemp()+"");
				//switchInfo = step.getSswitch();
				holder.experiment_new_main_item_body_switch_info_tv.setText(getSwitch(step.getSswitch()));
				holder.experiment_new_main_item_bottom_name_et.setText(step.getSname());
				...
				holder.experiment_new_main_item_body_temp_info_et.setOnClickListener(new OnClickListener() {
					public void onClick(View v) {
						if(!holder.experiment_new_main_item_body_switch_info_tv.getText().toString().equals(getString(R.string.exp_closs))){
							...
							View view = LayoutInflater.from(EditExperimentActivity.this).inflate(R.layout.activity_temp, null);
							...
							builder.setPositiveButton(getString(R.string.sure), new DialogInterface.OnClickListener() {
								public void onClick(DialogInterface dialog, int which) {
									if((temp_thousand.getCurrentItem()*100+temp_hundred.getCurrentItem()*10
										...
										editSteps.get(p).setStemp(temp_thousand.getCurrentItem()*100+temp_hundred.getCurrentItem()*10
				...
				holder.experiment_new_main_item_body_vol_info_et.setOnClickListener(new OnClickListener() {
					public void onClick(View v) {
						AlertDialog.Builder builder = new AlertDialog.Builder(EditExperimentActivity.this);
						builder.setTitle(getString(R.string.exp_temp_setting));
						View view = LayoutInflater.from(EditExperimentActivity.this).inflate(R.layout.activity_vol, null);
						builder.setView(view);
						builder.setCancelable(false);
						...
						builder.setPositiveButton(getString(R.string.sure), new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int which) {
								if((vol_thousand.getCurrentItem()*1000+vol_hundred.getCurrentItem()*100
									...
									Toast.makeText(EditExperimentActivity.this, getString(R.string.exp_vol_small), Toast.LENGTH_SHORT).show();
									try { 
										Field field = dialog.getClass().getSuperclass().getDeclaredField("mShowing"); 
										field.setAccessible(true); 
										field.set(dialog, false); 
									...
									editSteps.get(p).setSvol(vol_thousand.getCurrentItem()*1000+vol_hundred.getCurrentItem()*100
				...
				holder.experiment_new_main_item_head_wait_info_tv.setOnClickListener(new OnClickListener() {
					public void onClick(View v) {
						...
						View view = LayoutInflater.from(EditExperimentActivity.this).inflate(R.layout.activity_time_hour, null);
						...
						builder.setPositiveButton(getString(R.string.sure), new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int which) {
								...
								editSteps.get(p).setSwait(hours+":"+mins+":"+secs);
					...
					public void onClick(View v) {
						...
						builder.setPositiveButton(getString(R.string.sure), new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int which) {
								...
								editSteps.get(p).setSblend(hours+":"+mins+":"+secs);
				...
				holder.experiment_new_main_item_head_magnet_info_tv.setOnClickListener(new OnClickListener() {
					public void onClick(View v) {
						...
						View view = LayoutInflater.from(EditExperimentActivity.this).inflate(R.layout.activity_time_minute, null);
						...
						builder.setPositiveButton(getString(R.string.sure), new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int which) {
								...
								editSteps.get(p).setSmagnet("00:"+mins+":"+secs);
				...
				holder.experiment_new_main_item_body_hole_info_tv.setOnClickListener(new OnClickListener() {
					public void onClick(View v) {
						View view = LayoutInflater.from(EditExperimentActivity.this).inflate(R.layout.activity_experiment_new_main_item_hole, null);
						...
						experiment_new_main_item_hole_rg.setOnCheckedChangeListener(new OnCheckedChangeListener() {
							public void onCheckedChanged(RadioGroup group, int checkedId) {
								...
								editSteps.get(p).setShole(check);
				...
				holder.experiment_new_main_item_body_vol_info_et.addTextChangedListener(new TextWatcher() {
					public void onTextChanged(CharSequence s, int start, int before, int count) {
						if(s.length()>0){
							editSteps.get(p).setSvol(Integer.valueOf(s.toString()));
						}
						else{
				...
				holder.experiment_new_main_item_body_speed_info_tv.setOnClickListener(new OnClickListener() {
					public void onClick(View v) {
						View view = LayoutInflater.from(EditExperimentActivity.this).inflate(R.layout.activity_experiment_new_main_item_vol, null);
						...
						experiment_new_main_item_vol_rg.setOnCheckedChangeListener(new OnCheckedChangeListener() {
							public void onCheckedChanged(RadioGroup group, int checkedId) {
								...
								editSteps.get(p).setSspeed(speed);
				...
				holder.experiment_new_main_item_body_temp_info_et.addTextChangedListener(new TextWatcher() {
					public void onTextChanged(CharSequence s, int start, int before, int count) {}
					public void beforeTextChanged(CharSequence s, int start, int count,
							int after) {}
					public void afterTextChanged(Editable s) {
						if(!holder.experiment_new_main_item_body_temp_info_et.getText().toString().equals("")){
							if(Integer.valueOf(holder.experiment_new_main_item_body_temp_info_et.getText().toString())>120){
								Toast.makeText(EditExperimentActivity.this, getString(R.string.exp_temp_big), Toast.LENGTH_SHORT).show();
								editSteps.get(p).setStemp(120);
								holder.experiment_new_main_item_body_temp_info_et.setText("120");
							}
							else {
								editSteps.get(p).setStemp(Integer.valueOf(holder.experiment_new_main_item_body_temp_info_et.getText().toString()));
							}
				...
				holder.experiment_new_main_item_bottom_name_et.addTextChangedListener(new TextWatcher() {
					public void onTextChanged(CharSequence s, int start, int before, int count) {
						editSteps.get(p).setSname(holder.experiment_new_main_item_bottom_name_et.getText().toString());
					}
					public void beforeTextChanged(CharSequence s, int start, int count,
							int after) {}
					public void afterTextChanged(Editable s) {}
	...
	public boolean onTouchEvent(MotionEvent event) {  
	    ...
	    if (event.getAction() == MotionEvent.ACTION_DOWN) {
	        if (EditExperimentActivity.this.getCurrentFocus() != null) {  
	            if (EditExperimentActivity.this.getCurrentFocus().getWindowToken() != null) {  
	                imm.hideSoftInputFromWindow(EditExperimentActivity.this.getCurrentFocus().getWindowToken(),  
